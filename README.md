...
## Task 0: Visualization and Understanding the Data Structures (10 points)
...
#### Q 0.1: What classes does the image at index 2020 contain (index 2020 is the 2021-th image due to 0-based numbering)? (3 pt)
#### Q 0.2 Use Wandb to visualize the ground-truth bounding box and the class for the image at index 2020. (4 pt)
#### Q 0.3 Use Wandb to visualize the top ten bounding box proposals for the image at index 2020. (3 pt)


## Task 1: Is Object Localization Free? (50 points)
...
#### Q 1.6 Initialize the model from ImageNet (till the conv5 layer), initialize the rest of layers with Xavier initialization and train the model using batchsize=32, learning rate=0.01, epochs=30. Evaluate every 2 epochs. (Hint: also try lr=0.1 - best value varies with implementation of loss) \[Expected training time: 45mins-75mins]. (15 pt)
...
## Task 2: Weakly Supervised Deep Detection Networks (40 points)
...
## Task 3: Visualizing Class Activation Maps (Extra Credit - 10 points)
